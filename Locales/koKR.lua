...
L["No flask in your bags!"] = "가방에 영약이 없습니다!"
...
L["Only %d flasks (minimum %d)"] = "영약 %d개뿐 (최소 %d개)"
...
L["Also using PullReady"] = "PullReady 사용 중"
L["Also using PullReady %s"] = "PullReady %s 사용 중"
L["Whisper"] = "귓속말"
L["Sent"] = "보냄"
L["Whisper %s:"] = "%s에게 귓속말:"
L["Already whispered. Refresh this member to whisper again."] = "이미 귓속말을 보냈습니다. 다시 보내려면 이 구성원을 새로고침하세요."
L["Whispering in a raid is limited to the raid leader and assistants."] = "공격대에서는 공격대장과 부공격대장만 귓속말을 보낼 수 있습니다."
L["%d/%d inspected, %s%d with problems|r"] = "%d/%d 살펴봄, %s문제 %d명|r"
L["(paused in combat)"] = "(전투 중 일시 중지)"
L["Raid/Party Inspect requires a party or raid."] = "공격대/파티 살펴보기는 파티나 공격대에 속해 있어야 합니다."
