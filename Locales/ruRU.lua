...
L["No flask in your bags!"] = "В сумках нет настоев!"
...
L["Only %d flasks (minimum %d)"] = "Настоев: %d (минимум %d)"
...
L["Also using PullReady"] = "Тоже использует PullReady"
L["Also using PullReady %s"] = "Тоже использует PullReady %s"
L["Whisper"] = "Шепнуть"
L["Sent"] = "Отправлено"
...
L["Whispering in a raid is limited to the raid leader and assistants."] = "В рейде шептать могут только лидер и помощники."
L["%d/%d inspected, %s%d with problems|r"] = "Осмотрено %d/%d, %sс проблемами: %d|r"
L["(paused in combat)"] = "(пауза в бою)"
L["Raid/Party Inspect requires a party or raid."] = "Для осмотра рейда/группы нужна группа или рейд."
...
-- Shopping
L["Leg Armor"] = "Броня для ног"
L["Rings"] = "Кольца"
L["Weapons"] = "Оружие"
L["Nothing to buy!"] = "Покупать нечего!"
L["Only favourites"] = "Только избранное"
L["No favourites yet - right-click an item to add one."] = "Избранного пока нет - щёлкните по предмету ПКМ, чтобы добавить."
L["Show everything, not just what I am missing"] = "Показывать всё, а не только недостающее"
L["Showing %d of %d items"] = "Показано %d из %d предметов"
L["%d items"] = "Предметов: %d"
L["Shift-click an item to paste it into the auction house search."] = "Shift+щелчок по предмету вставляет его в поиск аукциона."
